...
if(Meteor.isServer) {
    describe('notes', function() {
        ...
        it('should update note', function() {
            ...
            // In array means parameters in notes.update
        ...
        it('shoudl throw error if extra updates provided', function() {
            expect(() => {
                Meteor.server.method_handlers['notes.update'].apply({
                    userId: noteOne.userId
                }, [
                    noteOne._id,
                    { title: 'new title', name: 'game' }
                ])
            }).toThrow()
        })

        it('should not updated note if user was not creator', function() {
            const title = 'Updated title'
